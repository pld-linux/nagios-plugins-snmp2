%define		proj_name	nagios-plugins-snmp
...
License:	GPL
Group:		Applications
Source0:	http://nagios.manubulon.com/%{proj_name}-%{version}.tgz
...
%doc AUTHORS ChangeLog NEWS README perl/nagios_plugins/ChangeLog.perl perl/nagios_plugins/doc/*
